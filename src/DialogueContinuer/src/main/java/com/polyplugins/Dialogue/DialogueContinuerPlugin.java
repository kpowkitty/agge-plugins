/**
 * @file DialogueContinuerPlugin.java
 * @class DialogueContinuerPlugin
 *
 * @author agge3
 * @version 1.0
 * @since 2024-06-18
 *
 * Derived in large part from DialogueContinuer.
...
@PluginDescriptor(
        name = "<html><font color=\"#73D216\">[A3]</font> Auto Dialoguer</html>",
