/**
 * @file StrategyExamplePlugin.java
 * @class StrategyExamplePlugin
 *
 * @author agge3
 * @version 1.0
 * @since 2024-06-18
 *
 * Derived in large part from StrategyExample.
...
@PluginDescriptor(
        name = "<html><font color=\"#73D216\">[A3]</font> StrategySmith</html>",
        description = "",
