/**
 * @file ShiftClickWalkertPlugin.java
 * @class ShiftClickWalkerPlugin
 *
 * @author agge3
 * @version 1.0
 * @since 2024-06-18
 *
 * Derived in large part from ShiftClickWalker.
...
@PluginDescriptor(
    name = "<html><font color=\"#73D216\">[A3]</font> Spoon Walk Under</html>",
    ...
    tags= {"agge", "plugin", "npcs", "items", "objects", "shift", "walk", "under", "walker"},
