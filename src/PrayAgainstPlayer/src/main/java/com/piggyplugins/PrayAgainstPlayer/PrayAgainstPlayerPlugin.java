/**
 * @file PrayAgainstPlayerPlugin.java
 * @class PrayAgainstPlayerPlugin
 *
 * @author agge3
 * @version 1.0
 * @since 2024-06-18
 *
 * Derived in large part from PrayAgainstPlayer.
...
@PluginDescriptor(
        name = "<html><font color=\"#73D216\">[A3]</font> Pray Vs Player</font>",
        description = "Use plugin in PvP situations for best results! (Ported from xKylee)",
        tags = {"agge", "plugin", "highlight", "pvp", "overlay", "players"},
